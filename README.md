...
<!-- ![](https://github.com/fredykohv/skills-build-applications-w-copilot-agent-mode/actions/workflows/0-start-course.yml/badge.svg?branch=main) -->
...
2. In the new tab, most of the fields will automatically fill in for you.
   ...
   - We recommend creating a public repository, as private repositories will use [Actions minutes](https://docs.github.chttps://github.com/fredykohv/skills-build-applications-w-copilot-agent-mode/billing/managing-billing-for-github-actions/about-billing-for-github-actions).
...
4. Click **Start Exercise**. Follow the step-by-step instructions and feedback will be provided as you progress.
   ...
   <a id="start-exercise" href="https://github.com/fredykohv/skills-build-applications-w-copilot-agent-mode/issues/1">
